...
const plans = [
    ...
    },
    {
        ...
        features: ['500 text generations', '200 image generations', 'Priority support',
                   'Access to pro models', 'Faster response time']
    },
    {
        _id: "premium",
        name: "Premium",
        ...
        features: ['1000 text generations', '500 image generations', '24/7 VIP support',
                   'Access to premium models', 'Dedicated account manager']
    }
...
export const purchasePlan = async(req,res) =>{
    ...
    cancel_url: `${origin}`,
    metadata: {transactionId:transaction._id.toString(),appId:'QuickChatBoat'} ,
